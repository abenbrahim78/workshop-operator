...
# workshop-operator.com/middleware-operator-bundle:$VERSION and workshop-operator.com/middleware-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= workshop-operator.com/middleware-operator
